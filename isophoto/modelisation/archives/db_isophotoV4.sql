...
-- object: don_fk | type: CONSTRAINT --
-- ALTER TABLE db_isophoto.commentaire DROP CONSTRAINT IF EXISTS don_fk CASCADE;
ALTER TABLE db_isophoto.commentaire ADD CONSTRAINT don_fk FOREIGN KEY (id_don)
REFERENCES db_isophoto.don (id) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --

-- object: commentaire_uq | type: CONSTRAINT --
-- ALTER TABLE db_isophoto.commentaire DROP CONSTRAINT IF EXISTS commentaire_uq CASCADE;
ALTER TABLE db_isophoto.commentaire ADD CONSTRAINT commentaire_uq UNIQUE (id_don);
-- ddl-end --
