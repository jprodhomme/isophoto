...
-- object: db_isophoto.many_commentaires_has_many_photo | type: TABLE --
-- DROP TABLE IF EXISTS db_isophoto.many_commentaires_has_many_photo CASCADE;
CREATE TABLE db_isophoto.many_commentaires_has_many_photo(
	id_commentaires integer NOT NULL,
	id_photo integer NOT NULL,
	CONSTRAINT many_commentaires_has_many_photo_pk PRIMARY KEY (id_commentaires,id_photo)

);
-- ddl-end --

-- object: commentaires_fk | type: CONSTRAINT --
-- ALTER TABLE db_isophoto.many_commentaires_has_many_photo DROP CONSTRAINT IF EXISTS commentaires_fk CASCADE;
ALTER TABLE db_isophoto.many_commentaires_has_many_photo ADD CONSTRAINT commentaires_fk FOREIGN KEY (id_commentaires)
REFERENCES db_isophoto.commentaires (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: photo_fk | type: CONSTRAINT --
-- ALTER TABLE db_isophoto.many_commentaires_has_many_photo DROP CONSTRAINT IF EXISTS photo_fk CASCADE;
ALTER TABLE db_isophoto.many_commentaires_has_many_photo ADD CONSTRAINT photo_fk FOREIGN KEY (id_photo)
REFERENCES db_isophoto.photo (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
